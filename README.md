...
| Structured Aleatoric Uncertainty in Human Pose Estimation | CVPR 2019 | Yes  | Idea: Joins are approximated by multivariate Gaussian distr to use it as aleatoric uncertainty |
...
| Fast Uncertainty Quantification for Deep Object Pose Estimation | https://arxiv.org/pdf/2011.07748.pdf | Yes |   | Idea: Spearman's rank correlation between pose error and UQ |
...
| # Paper Title       | # Link | # Uncertainty Estimation | # Code |  # Comment |
| :------------------------------------------------------ |:--------------------| :-----| :-------------|:------------ |
| Camera Distance-aware Top-Down approach for 3D Multi-person pose estimation | ICCV 2019 | No | https://github.com/mks0601/3DMPPE_ROOTNET_RELEASEhttps://github.com/mks0601/3DMPPE_ROOTNET_RELEASE | Multi-stage : DetectNet(MaskRCNN) + PoseNet + RootNet+ No dropout |
...
| 3D Human Pose Estimation with 2D Marginal Heatmaps | https://arxiv.org/pdf/1806.01484.pdf | No |   | Idea: Regularization If we want to encourage heatmaps to mimic the shape of a specific probability distribution, we can minimise the the Jensen-Shannon divergence (JSD) [11] from that particular distribution. |
|  |  |  |  |  |  |
...
| What Uncertainties Do We Need in Bayesian DeepLearning for Computer Vision? | NIPS2017 |  |  |  |  |
| Towads robust methods for CV | https://arxiv.org/pdf/1906.01620.pdf |  |  |  |  |
| Lightweight Probabilistic Deep Networks | CVPR 2018|  |  |  |  |
